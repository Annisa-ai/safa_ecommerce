            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {step === 'payment' && (
                <Card className="p-8 border border-border">
                  ...
                  <div className="p-5 border-2 border-primary rounded-xl bg-primary/5">
                    <div className="flex justify-between items-center">
                      <div>
                        <p className="font-semibold text-foreground">Midtrans Snap (Pop-up)</p>
                        <p className="text-xs text-muted-foreground mt-0.5">Virtual Account, QRIS, E-Wallet, Kartu Kredit, dan Convenience Store</p>
                      </div>
                      <span className="text-xs font-bold px-2 py-0.5 rounded bg-primary text-primary-foreground">Pop-up</span>
                    </div>
                  </div>
